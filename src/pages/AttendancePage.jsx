...
const AttendancePage = () => {
  ...
  const statusOptions = [
    ...
    { value: 'leave', label: 'L', color: 'bg-blue-500', textColor: 'text-white', icon: Umbrella },
            ...
            <table className="w-full border-collapse">
              <thead>
                ...
                <tr className="bg-slate-50 border-b border-slate-200">
                  ...
                  <th className="px-3 py-2 text-center text-xs font-semibold text-slate-700 bg-blue-50">
                    L
                  </th>
                </tr>
                ...
                {employees.map((employee, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-2 text-center text-sm font-bold text-blue-700 bg-blue-50">
                        {summary.leave}
                      </td>
                    </tr>
                  );
