            ...
            <CardContent>
              <form onSubmit={handleSaveWhatsApp} className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className={`flex items-start space-x-3 p-4 border rounded-lg transition-colors ${whatsappProvider === 'twilio' ? 'border-blue-300 bg-blue-50/50' : 'border-slate-200'} ${!whatsappEnabled ? 'opacity-50' : ''}`}>
