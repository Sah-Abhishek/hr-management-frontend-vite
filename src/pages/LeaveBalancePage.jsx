      ...
      days.push(
        ...
        >
          <div className="flex items-center justify-between">
            <div className={`text-sm font-medium ${isToday ? 'text-blue-600' : holiday ? 'text-red-600' : isWeekend ? 'text-slate-400' : 'text-slate-700'}`}>
              {day}
            </div>
            {holiday && (
          ...
          <Card className="border-slate-100 shadow-sm">
            <CardContent className="py-4">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-3 pt-3 border-t border-slate-200">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded border-2 bg-blue-50 border-blue-500" />
