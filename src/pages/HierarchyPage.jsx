                        ...
                        <div className="inline-flex flex-col items-center">
                          {deptAdmins.map((admin, idx) => (
                            <div key={admin.id} className="relative">
                              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl shadow-lg mb-4 min-w-[280px]">
                                ...
                                <div className="flex-1">
                                  ...
                                  <p className="text-sm text-blue-100">{admin.designation}</p>
                                </div>
                                <Badge className="bg-white text-blue-700 hover:bg-white font-semibold">CEO/Admin</Badge>
                              </div>
                              {/* Connector line down */}
