            ...
            <CardContent className="p-3 sm:p-6 pt-0 sm:pt-0">
              <div className="grid grid-cols-2 sm:grid-cols-1 gap-2 sm:gap-3">
                ...
                <div className="p-2 sm:p-3 bg-blue-50 rounded-lg border border-blue-100">
                  <p className="text-[10px] sm:text-xs font-medium text-blue-700 mb-0.5 sm:mb-1">Casual Leave</p>
                  <p className="text-lg sm:text-2xl font-bold text-blue-900">{employee.leave_balance?.casual_leave ?? 0}</p>
                  <p className="text-[10px] sm:text-xs text-blue-600">days remaining</p>
                </div>
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <div className="p-2 sm:p-3 bg-blue-50 rounded-lg text-center border border-blue-200">
                ...
                <p className="text-[10px] sm:text-xs text-blue-600">Total Granted</p>
              </div>
