...
const MyReimbursementsPage = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case 'approved':
        return (
          <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 gap-1 text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-5 sm:mb-8">
          ...
          <Card className="border-0 shadow-md bg-gradient-to-br from-blue-50 to-indigo-50">
            <CardContent className="p-2.5 sm:p-4 md:p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div className="order-2 sm:order-1">
                  <p className="text-[10px] sm:text-xs md:text-sm text-blue-600 font-medium">Requests</p>
                  <p className="text-sm sm:text-xl md:text-2xl font-bold text-blue-700">{reimbursements.length}</p>
                </div>
                <div className="p-1.5 sm:p-2 md:p-3 bg-blue-200 rounded-lg sm:rounded-xl order-1 sm:order-2 w-fit">
                  <FileText className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-blue-700" />
                </div>
              </div>
            </CardContent>
          </Card>
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 sm:mt-2">
                        {reimbursement.bill_url && (
                          <a
                            ...
                            className="inline-flex items-center gap-0.5 sm:gap-1 text-[10px] sm:text-xs text-blue-600 hover:text-blue-700"
                          >
                        ...
                        {reimbursement.status === 'pending' && (
                          <>
                            <Button
                              ...
                              className="text-blue-500 hover:text-blue-700 hover:bg-blue-50 h-6 w-6 sm:h-7 sm:w-auto p-0 sm:px-2"
                            >
